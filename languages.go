...
// Language - Language name including it's native name.
type Language struct {
	Name       string
	NativeName string
}

// languageByCode - Languages by country short code.
...
// codeByLanguageName - Code of the language by it's name (not native).
var codeByLanguageName map[string]string

func init() {
	for code, language := range languageByCode {
		codeByLanguageName[language.Name] = code
	}
}

// LanguageByCode - Returns name of a language by it's short code.
func LanguageByCode(code string) *Language {
	code = strings.ToLower(code)
	return languageByCode[code]
}

// CodeByLanguage - Returns language short code by it's name (not native).
func CodeByLanguage(language string) string {
	return codeByLanguageName[language]
}
